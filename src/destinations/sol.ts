...
export const sol: Destination = {
  ...
  bodies: [
    {
      ...
      star: {
        color: [1.0, 0.46, 0.1],
        hotColor: [1.0, 0.9, 0.6],
        emissiveIntensity: 1.7,
        granulationScale: 3.2,
        flowSpeed: 0.05,
    ...
    },
    {
      ...
      position: [9, 0, 0],
      rotationPeriod: 40,
      surface: { landColor: [0.45, 0.38, 0.32], roughness: 0.95 },
    },
    {
      id: 'ocean-world',
      kind: 'earthlike',
    ...
    },
    {
      ...
      position: [22, 0, -5],
      rotationPeriod: 26,
      surface: { landColor: [0.55, 0.25, 0.15], roughness: 0.95 },
    },
    {
      id: 'gas-giant',
      kind: 'gasgiant',
  ...
  camera: {
    ...
    minDistance: 8,
    maxDistance: 320,
    arriveFrom: [60, 140, 360],
    autoRotate: true,
    autoRotateSpeed: 0.04,
  },
  post: { exposure: 1.0, bloomStrength: 0.6, bloomRadius: 0.55, bloomThreshold: 0.78, vignette: 0.5, grain: 0.025 },
