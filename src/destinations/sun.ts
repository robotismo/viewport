...
export const sun: Destination = {
  ...
  intent:
    ...
    'cells boil and drift, the disc darkens toward a cooler limb ringed by a ' +
    'thread of chromospheric fire, and the corona breathes around the edge. Bloom ' +
    'does the rest: the star reads as a light source you instinctively want to ' +
  ...
  bodies: [
    {
      ...
      star: {
        color: [1.0, 0.5, 0.16],
        hotColor: [1.0, 0.91, 0.7],
        emissiveIntensity: 2.0,
        granulationScale: 4.2,
        flowSpeed: 0.06,
  ...
  post: { exposure: 1.0, bloomStrength: 0.52, bloomRadius: 0.5, bloomThreshold: 0.8, vignette: 0.5, grain: 0.03, flare: 0 },
